...
import { IconCalendar, IconClose, IconHome, IconUser } from "@/components/Layout/icons";

const nav = [
  { to: "/teacher", label: "Home", Icon: IconHome, end: true },
  { to: "/teacher/schedule", label: "Schedule", Icon: IconCalendar, end: false },
  { to: "/teacher/profile", label: "Profile", Icon: IconUser, end: false },
] as const;
      ...
      <div className="mb-8 flex items-center justify-between px-2 md:justify-start">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-ink/55 dark:text-ink-dark/55">Teacher</p>
          </div>
        </div>
        <button
          type="button"
